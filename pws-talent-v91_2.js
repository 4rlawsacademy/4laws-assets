...
(function() {
  ...
  */
  ...
  function pwsEquipWallHTML(fsIdx, cfg, es) {
    ...
    h += '<img src="https://cdn.jsdelivr.net/gh/4rlawsacademy/4laws-assets@main/chainsaw-bucket-icon.jpg" alt="" title="' + (es ? 'Toca o suelta un archivo aqu\u00ed' : 'Tap or drop a file here') + '" onerror="this.style.display=\'none\'"'
      ...
      + ' style="display:block;margin:0 auto 6px;width:96px;border-radius:6px;box-shadow:0 3px 12px rgba(0,0,0,0.5);cursor:pointer;">';
  ...
  function pwsRenderUseFooter(isTimer, isMedia, savedLink) {
    ...
    flagImg.style.cssText = 'display:block;margin:2px auto 8px;width:150px;max-width:60%;border-radius:8px;box-shadow:0 4px 16px rgba(0,0,0,0.55), 0 0 12px rgba(200,168,75,0.22);';
