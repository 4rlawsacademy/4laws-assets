/* 4 LAWS ACADEMY - pws-talent-v89.js - THE BUCKET FRONT
...
(function() {
  ...
  */
  ...
  function pwsRenderRange_() {
    ...
    badge.src = 'https://cdn.jsdelivr.net/gh/4rlawsacademy/4laws-assets@main/chainsaw-bucket-icon.jpg';
    badge.alt = '';
    badge.onerror = function() { badge.style.display = 'none'; };
    badge.style.cssText = 'display:block;margin:2px auto 8px;width:150px;max-width:60%;border-radius:8px;box-shadow:0 4px 16px rgba(0,0,0,0.55), 0 0 12px rgba(200,168,75,0.22);';
