  ...
  */
  ...
  (function pwsArmoryCss_() {
    ...
    st.appendChild(document.createTextNode(
      ...
      '.pws-armory-title .pws-acc-n{font-size:14px;letter-spacing:0.14em;color:#f2d585;font-weight:700;}' +
  ...
  function pwsHangShelves_(container) {
    ...
    var at1 = document.createElement('span'); at1.textContent = es ? 'LA ARMER\u00cdA' : 'THE ARMORY'; var at2 = document.createElement('span'); at2.className = 'pws-acc-n'; at2.textContent = weapons.length + (es ? ' ARMAS' : ' WEAPONS');
