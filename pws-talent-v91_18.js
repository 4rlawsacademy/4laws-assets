...
(function() {
  ...
  */
  ...
  function pwsRenderToolsTile() {
    ...
    if (stageHasOrgan) {
      ...
      window.SuperBucket.mount(stageBucketHost, {
        ...
        face: 'chainsaw',
        promiseEn: 'Drop a bill, a letter, a photo \u2014 Doc B reads it and starts your tool',
        promiseEs: 'Suelta una factura, una carta, una foto \u2014 Doc B la lee y empieza tu herramienta',
        accept: 'image/*,application/pdf,.pdf,.png,.jpg,.jpeg,.gif,.webp,.heic',
        askTitle: false,
    ...
    stageFileInp.accept = 'image/*,application/pdf';
  ...
  function pwsRenderUseFooter(isTimer, isMedia, savedLink) {
    ...
    if (window.SuperBucket) {
      ...
      window.SuperBucket.mount(useBucketHost, {
        lang: function() { return _lang; },
        face: 'chainsaw',
        promiseEn: 'Drop it here \u2014 Doc B reads it',
  ...
  function pwsUseFileToDocB_(file) {
    ...
    if (!isPdf && !isImage) { pwsViewToast_(_lang === 'es' ? 'Doc B lee im\u00e1genes y PDF' : 'Doc B reads images and PDFs'); return; }
    var reader = new FileReader();
    reader.onloadend = function() {
  ...
  window.pwsSendUse = function pwsSendUse() {
    ...
    var imgCapability = 'IMAGE CAPABILITY: You can receive and describe screenshots, photos, and PDF documents dropped in the bucket. If the member shares an image or document, describe what you see and connect it to their work.\n\n';
