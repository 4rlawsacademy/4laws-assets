...
(function() {
  ...
  */
  ...
  function pwsEquipWallHTML(fsIdx, cfg, es) {
    ...
    h += '<img src="https://cdn.jsdelivr.net/gh/4rlawsacademy/4laws-assets@main/chainsaw-bucket-icon.jpg" alt="" onerror="this.style.display=\'none\'" style="display:block;margin:0 auto 6px;width:96px;border-radius:6px;box-shadow:0 3px 12px rgba(0,0,0,0.5);">';
