  ...
  */
  ...
  (function pwsArmoryCss_() {
    ...
    st.appendChild(document.createTextNode(
      ...
      '#pwsBeltRow .pws-belt-title{font-family:Cinzel,serif;font-weight:700;font-size:26px;letter-spacing:0.2em;color:#f2d585;text-shadow:0 2px 10px rgba(0,0,0,1),0 0 18px rgba(0,0,0,0.9);margin:0 0 12px;display:flex;justify-content:space-between;align-items:baseline;gap:12px;}' +
      ...
      '#pwsBeltRow{background-size:cover;background-position:center;background-repeat:no-repeat;min-height:170px;padding:16px 14px 12px;border:1px solid rgba(200,168,75,0.6) !important;box-shadow:0 8px 28px rgba(0,0,0,0.5);}' +
      ...
      '#pwsBeltRow .pws-medal-fig{width:72px;height:72px;border-radius:50%;border:3px solid #c8a84b;box-shadow:0 0 0 2px #1a1408,0 0 14px rgba(200,168,75,0.55),inset 0 0 12px rgba(0,0,0,0.6);background:#0d1117 center/cover no-repeat;}' +
      ...
      '@media (max-width:640px){#pwsBeltRow .pws-belt-tiles{grid-template-columns:repeat(4,minmax(0,1fr));}#pwsBeltRow .pws-medal-fig{width:60px;height:60px;}}' +
  ...
  function pwsHangShelves_(container) {
    ...
    /* the accordions */
    function acc(title, n, open) { var a = document.createElement('div'); a.className = 'pws-acc' + (open ? ' open' : ''); var hd = document.createElement('div'); hd.className = 'pws-acc-head'; var t1 = document.createElement('span'); t1.textContent = title; var t2 = document.createElement('span'); t2.className = 'pws-acc-n'; t2.textContent = n; hd.appendChild(t1); hd.appendChild(t2); var bd = document.createElement('div'); bd.className = 'pws-acc-body'; hd.addEventListener('click', function() { a.classList.toggle('open'); }); a.appendChild(hd); a.appendChild(bd); return { el: a, body: bd }; }
    var dailyAcc = acc(es ? 'HERRAMIENTAS DE CADA D\u00cdA' : 'DAILY ACTIVITY TOOLS', daily.length + (es ? ' HERRAMIENTAS' : ' TOOLS'), false);
    ...
    var armoryAcc = acc(es ? 'MONSTRUOS' : 'MONSTERS', es ? 'TOCA UNO' : 'TAP ONE', true);
