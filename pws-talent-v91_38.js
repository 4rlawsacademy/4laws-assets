  ...
  */
  ...
  (function pwsArmoryCss_() {
    ...
    st.appendChild(document.createTextNode(
      ...
      '.pws-shelf-head{position:relative;min-height:92px;cursor:pointer;background:linear-gradient(135deg,#0d1117 0%,#1a1408 100%);background-size:cover;background-position:center;}' +
      '.pws-shelf.open .pws-shelf-head{min-height:150px;}' +
  ...
  window.pwsBrunoBoot_ = function pwsBrunoBoot_() { try { if (!_useTool && _session && _memberId) { pwsArmoryFetch_(function() { pwsBrunoOpen_('', true); }); } } catch (eB) {} };   /* v91_38: read the eye, then dock closed */   /* v91_37: loaded, but closed -- a card */
