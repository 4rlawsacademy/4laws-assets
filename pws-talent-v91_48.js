  ...
  */
  ...
  (function pwsArmoryCss_() {
    ...
    st.appendChild(document.createTextNode(
      ...
      '.pws-acc-head{display:flex;justify-content:space-between;align-items:center;padding:14px 16px;cursor:pointer;font-family:Cinzel,serif;font-weight:700;font-size:15px;letter-spacing:0.18em;color:#f2d585;}' +
      '.pws-acc-head .pws-acc-n{font-size:11px;letter-spacing:0.14em;color:rgba(240,230,204,0.6);font-weight:400;}' +
  ...
  function pwsBeltRender_() {
    ...
    for (var si = 0; si < maxN; si++) {
      ...
      var b = document.createElement('button'); b.type = 'button'; b.className = 'pws-medal' + (it && (row.pins || []).indexOf(it.key) !== -1 ? ' pinned' : '');
      ...
      (function(item) {
        b.addEventListener('click', function () {
          if (!item) { try { window.Belt.say(es ? 'Un lugar libre. Abre un arma en la Armer\u00eda y toca PONER EN EL CINTUR\u00d3N.' : 'An empty setting. Open a weapon in the Armory and tap PUT ON THE BELT.'); } catch (e0) {} return; }
  ...
  function pwsRenderToolsTile() {
    ...
    container.appendChild(arsenalCard);
  ...
  function pwsHangShelves_(container) {
    ...
    function drawRack(filterKey) {
      ...
      list.forEach(function(w) {
        ...
        c.addEventListener('click', function() { if (_openKey === w.key) { panel.style.display = 'none'; _openKey = ''; c.classList.remove('open'); } else { showPanel(w); } });
        rack.appendChild(c);
      });
