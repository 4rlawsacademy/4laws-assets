  ...
  function pwsRenderToolsTile() {
    ...
    if (stageHasOrgan) {
      ...
      window.SuperBucket.mount(stageBucketHost, {
        ...
        accept: 'image/*,application/pdf,.pdf,.doc,.docx,.txt,.md,.csv,.json,text/plain,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document',
        allow: 'any', /* v91_19: organ v1.2 door open; pwsStageFileDrop_ does the honest typing */
        askTitle: false,
  ...
  function pwsRenderUseFooter(isTimer, isMedia, savedLink) {
    ...
    if (window.SuperBucket) {
      ...
      window.SuperBucket.mount(useBucketHost, {
        lang: function() { return _lang; },
        face: 'chainsaw',
        promiseEn: 'Drop it here \u2014 Doc B reads it (photo, PDF, Word, text)',
        promiseEs: 'Su\u00e9ltalo aqu\u00ed \u2014 Doc B lo lee (foto, PDF, Word, texto)',
        accept: 'image/*,application/pdf,.pdf,.doc,.docx,.txt,.md,.csv,.json,text/plain,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document',
        allow: 'any', /* v91_19: organ v1.2 door open; pwsUseFileToDocB_ does the honest typing */
        askTitle: false,
        onFile: function(file) { pwsUseFilesToDocB_([file]); },
        onFiles: function(files) { pwsUseFilesToDocB_(files); } /* v91_20 THE WHOLE HANDFUL (organ v1.3) */
      });
