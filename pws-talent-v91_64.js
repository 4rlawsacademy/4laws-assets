  ...
  */
  ...
  (function pwsArmoryCss_() {
    ...
    st.appendChild(document.createTextNode(
      ...
      '#pwsBeltRow{margin:0 0 14px;padding:12px 14px;border:1px solid rgba(200,168,75,0.35);border-radius:10px;background:rgba(4,6,8,0.6);}' +
      '#pwsBeltRow .pws-belt-title{font-family:Cinzel,serif;font-weight:700;font-size:26px;letter-spacing:0.2em;color:#f2d585;text-shadow:0 2px 10px rgba(0,0,0,1),0 0 18px rgba(0,0,0,0.9);margin:0 0 8px;display:flex;justify-content:space-between;align-items:baseline;gap:12px;}' +
      '#pwsBeltRow .pws-belt-note{font-family:Cinzel,serif;font-weight:700;font-style:normal;font-size:14px;color:#f2d585;letter-spacing:0.14em;text-transform:uppercase;text-shadow:0 2px 8px rgba(0,0,0,1);}' +
      '#pwsBeltRow{background-size:cover;background-position:center;background-repeat:no-repeat;min-height:0;padding:12px 14px 10px;border:1px solid rgba(200,168,75,0.6) !important;box-shadow:0 8px 28px rgba(0,0,0,0.5);}' +
      '#pwsBeltRow .pws-belt-tiles{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:6px;align-items:start;}' +
      '#pwsBeltRow .pws-medal{display:flex;flex-direction:column;align-items:center;gap:6px;cursor:pointer;background:transparent;border:none;padding:0;min-width:0;}' +
      '#pwsBeltRow .pws-medal-fig{width:60px;height:60px;border-radius:50%;border:3px solid #c8a84b;box-shadow:0 0 0 2px #1a1408,0 0 14px rgba(200,168,75,0.55),inset 0 0 12px rgba(0,0,0,0.6);background:#0d1117 center/cover no-repeat;}' +
      '#pwsBeltRow .pws-medal-fig.empty{background:radial-gradient(circle at 50% 45%,rgba(200,168,75,0.12),rgba(4,6,8,0.85) 70%);border-style:dashed;border-color:rgba(200,168,75,0.55);box-shadow:none;}' +
      '#pwsBeltRow .pws-medal.pinned .pws-medal-fig{border-color:#fff3c4;}' +
      '#pwsBeltRow .pws-medal-name{font-family:Cinzel,serif;font-weight:700;font-size:11px;letter-spacing:0.06em;color:#f2d585;text-align:center;line-height:1.15;text-shadow:0 2px 6px rgba(0,0,0,1);max-width:100%;overflow:hidden;}' +
      '#pwsBeltRow .pws-medal:hover .pws-medal-fig{transform:scale(1.08);transition:transform .15s ease;}' +
      '#pwsBeltRow .pws-medal.over .pws-medal-fig{transform:scale(1.15);border-color:#fff3c4;box-shadow:0 0 0 3px #1a1408,0 0 22px #f2d585;}' +
      '#pwsBeltRow .pws-medal{position:relative;}' +
      '#pwsBeltRow .pws-medal .pws-medal-x{position:absolute;top:-6px;right:calc(50% - 44px);width:22px;height:22px;border-radius:50%;background:#7a1a1a;color:#fff;border:1px solid #f2d585;font-size:13px;line-height:20px;text-align:center;display:none;cursor:pointer;z-index:2;}' +
      '#pwsBeltRow .pws-medal.armed:hover .pws-medal-x,#pwsBeltRow .pws-medal.held .pws-medal-x{display:block;}' +
      ...
      '#pwsBeltRow .pws-belt-say{position:absolute;left:0;right:0;bottom:4px;text-align:center;font-family:\'Cormorant Garamond\',serif;font-style:italic;font-size:17px;color:#fff3c4;text-shadow:0 2px 8px rgba(0,0,0,1);margin-top:8px;display:none;}' +
      '#pwsBeltRow.arming .pws-belt-say{display:block;}' +
      '#pwsBeltRow{position:relative;padding-bottom:6px;}' +
      '#pwsBeltRow .pws-belt-whisper{position:absolute;left:0;right:0;bottom:4px;text-align:center;font-family:Cinzel,serif;font-weight:700;font-size:22px;letter-spacing:0.06em;color:#fff3c4;text-shadow:0 2px 10px rgba(0,0,0,1),0 0 18px rgba(0,0,0,0.9);opacity:0;transition:opacity .35s ease;pointer-events:none;}' +
      '#pwsBeltRow .pws-belt-say{font-family:Cinzel,serif;font-weight:700;font-style:normal;font-size:22px;}' +
      '@media (max-width:640px){#pwsBeltRow .pws-belt-whisper{font-size:18px;}}' +
      '#pwsBeltRow.whisper .pws-belt-whisper{opacity:1;}' +
      ...
      '@media (max-width:640px){#pwsBeltRow .pws-belt-tiles{grid-template-columns:repeat(4,minmax(0,1fr));gap:4px;}#pwsBeltRow .pws-medal-fig{width:50px;height:50px;}#pwsBeltRow .pws-medal-name{font-size:10px;}}' +
      ...
      '@media (max-width:640px){.pws-acc-head{font-size:20px;letter-spacing:0.14em;}#pwsBeltRow .pws-belt-title{font-size:20px;letter-spacing:0.14em;}}' +
  ...
  var RESPECT_RELS = [
    { key: 'heart',   en: 'YOUR HEART',            es: 'TU CORAZ\u00d3N',        who: { en: 'your connection to your inner self, your heart, God', es: 'tu conexi\u00f3n con tu interior, tu coraz\u00f3n, Dios' } },
    { key: 'spouse',  en: 'YOUR SPOUSE',           es: 'TU PAREJA',               who: { en: 'your spouse', es: 'tu pareja' } },
    { key: 'children',en: 'YOUR CHILDREN',         es: 'TUS HIJOS',               who: { en: 'your children', es: 'tus hijos' } },
    { key: 'origin',  en: 'YOUR FAMILY OF ORIGIN', es: 'TU FAMILIA DE ORIGEN',    who: { en: 'your family of origin', es: 'tu familia de origen' } },
    { key: 'friends', en: 'CLOSE FRIENDS',         es: 'AMIGOS CERCANOS',         who: { en: 'your close friends', es: 'tus amigos cercanos' } },
    { key: 'others',  en: 'EVERYONE ELSE',         es: 'TODOS LOS DEM\u00c1S',   who: { en: 'everyone else', es: 'todos los dem\u00e1s' } }
  ];
  ...
  function pwsRespectRow_() {
    ...
    for (var k in c.rels) { if (!c.rels.hasOwnProperty(k) || !c.rels[k]) continue; var r = c.rels[k]; if (Array.isArray(r.goals)) { r.goals = r.goals.map(function(g) { return (g && typeof g === 'object') ? g : { text: String(g), at: r.at || new Date().toISOString() }; }); } else { r.goals = []; } if (!Array.isArray(r.ratings)) r.ratings = []; }
    return c;
  }
  ...
  function pwsRelByKey_(k) { for (var i = 0; i < RESPECT_RELS.length; i++) { if (RESPECT_RELS[i].key === k) return RESPECT_RELS[i]; } return null; }
  ...
  function pwsRespectPrompt_(tool) {
    ...
    var base = 'You are DOC B AI at the Respect card of 4 LAWS Academy (founder: Dr. Eduardo M. Bustamante, clinical psychologist). The Law of Respect says GIVE IMPORTANCE. You are warm, plain, unhurried; 2-3 sentences; ONE question at a time; never a lecture, never a grade, never a diagnosis of the person. '
      + 'THE ORDER OF IMPORTANCE (fixed, the law itself): 1 your heart (your inner self, God) \u00b7 2 your spouse \u00b7 3 your children \u00b7 4 your family of origin \u00b7 5 close friends \u00b7 6 everyone else. '
    ...
    if (tool.respectKind === 'rel') {
      var rel = pwsRelByKey_(tool.respectRel), rec = row.rels[tool.respectRel];
      return base + 'THIS ROOM is about ' + rel.who.en + ' (position ' + (RESPECT_RELS.indexOf(rel) + 1) + ' in the order). '
        ...
        + 'Never emit the line before all six are answered. When a goal needs a weapon, name it by name: THE VANISHER (the invisibility game), THE EXPOSER, or THE REPLACER. Respond in ' + (es ? 'Spanish' : 'English') + '.';
    }
    ...
    if (tool.respectKind === 'adj') {
      ...
      return base + 'THIS ROOM is THE REPLACER \u2014 the scalpel; the weapon against the Ghost. Slowly: (1) who is making the member less important, and what exactly did they do (the violation)? (2) YOU judge, from the violation, the rung that person now belongs on in the order (1-6; e.g. a spouse out with friends every night while the family waits belongs, for now, at 5 \u2014 among the friends, in a friend\u2019s role) and say so plainly with the reason. (3) The member chooses who RECEIVES the importance \u2014 a person already on the order, or new people to find (even new friends through social media) \u2014 and the first act toward them. (4) THE GUARD: the adjustment is never recorded in anger or at night; ask the member to say the whole plan out loud in one breath: the reason, the new rung, who receives, the first act. Only when they have, end your reply with this exact final line and nothing after it: ADJUSTMENT {\"who\":\"<name>\",\"fromRel\":\"<heart|spouse|children|origin|friends|others>\",\"toRung\":<1-6>,\"reason\":\"...\",\"replacement\":\"<who receives>\",\"firstAct\":\"...\"}. The door stays open: say that any adjustment can be reversed. '
  ...
  function pwsRespectRender_() {
    ...
    RESPECT_RELS.forEach(function(r, i) {
      ...
      var fig = document.createElement('div'); fig.className = 'pws-monster-fig'; var im = imgs['respect' + (i + 1)] || ''; if (im) fig.style.backgroundImage = 'url(' + JSON.stringify(im) + ')';
    ...
    /* v91_63: the line under the six, there whenever they are on screen */
    var osay = document.createElement('div'); osay.className = 'pws-order-say'; osay.textContent = es ? 'Construye aqu\u00ed tu mundo de relaciones.' : 'Build your relationship world here.'; host.appendChild(osay);
